...
if project_num == 1:
    ...
    if step == 'Business Understanding':
        ...
        * Doanh thu từ việc bán giảm mạnh trong khoảng từ tháng 01/1997 đến tháng 04/1997, sau đó không có sự thay đổi quá lớn ''')
        ...
        RFM_Analysis_ON = st.toggle('RFM Analysis')
        RFM_Kmeans_ON = st.toggle('RFM + K-means')
        RFM_HierarchicalClustering_ON = st.toggle('RFM + Hierarchical Clustering')
        RFM_Kmeans_BigData_ON = st.toggle('RFM + K-means (Big Data)')
